...
const styles = StyleSheet.create({
  wrap: { borderWidth: 1, borderColor: Colors.border, padding: 12, borderRadius: 12, marginBottom: 10, backgroundColor: Colors.card },
  row: { flexDirection: 'row', alignItems: 'center', marginTop: 6 },
  input: { backgroundColor: '#fff', borderWidth: 1, borderColor: Colors.border, borderRadius: 10, paddingHorizontal: 12, paddingVertical: 10, marginTop: 8, flexGrow: 1 },
  small: { width: 70 },
  remove: { marginTop: 8, backgroundColor: Colors.danger, paddingVertical: 8, borderRadius: 10, alignItems: 'center' },
});
